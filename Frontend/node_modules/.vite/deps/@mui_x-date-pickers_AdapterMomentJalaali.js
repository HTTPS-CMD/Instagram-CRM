import {
  require_moment
} from "./chunk-XLSVXB7N.js";
import {
  moment_default
} from "./chunk-U65GDRMT.js";
import {
  _extends
...
// node_modules/@mui/x-date-pickers/esm/AdapterMomentJalaali/AdapterMomentJalaali.js
var import_moment_jalaali = __toESM(require_moment_jalaali(), 1);

// node_modules/@mui/x-date-pickers/esm/AdapterMoment/AdapterMoment.js
var formatTokenMap = {
  // Year
  Y: "year",
  YY: "year",
...
var AdapterMoment = class {
  ...
  getInvalidDate = () => this.moment(/* @__PURE__ */ new Date("Invalid Date"));
  getTimezone = (value) => {
...
var AdapterMomentJalaali = class extends AdapterMoment {
  isTimezoneCompatible = false;
  lib = "moment-jalaali";
  formatTokenMap = /* @__PURE__ */ (() => formatTokenMap2)();
  constructor({
    formats,
    instance
  } = {}) {
    ...
    this.moment = instance || import_moment_jalaali.default;
    this.locale = "fa";
    this.formats = _extends({}, defaultFormats2, formats);
  }
  date = (value) => {
    if (value === null) {
      return null;
...
//# sourceMappingURL=@mui_x-date-pickers_AdapterMomentJalaali.js.map
