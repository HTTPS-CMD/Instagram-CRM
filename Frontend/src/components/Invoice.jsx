        ...
        <div ref={ref} style={{
            ...
            <Box sx={{
                ...
                <Box sx={{display: 'flex', alignItems: 'center', gap: 2}}>
                    ...
                    <Box>
                        <Typography variant="h4" fontWeight="bold" sx={{fontSize: '24px', color: '#000'}}>فاکتور
                            رسمی</Typography>
                ...
                <Box sx={{textAlign: 'left'}}>
                    <Typography variant="body2" sx={{fontSize: '14px', color: '#000'}}><strong>شماره
                        فاکتور:</strong> {payment.id}</Typography>
                    <Typography variant="body2" sx={{fontSize: '14px', color: '#000'}}><strong>تاریخ
                        صدور:</strong> {moment(payment.date).locale('fa').format('jYYYY/jMM/jDD')}</Typography>
                </Box>
            </Box>
            ...
            <Grid container spacing={3} sx={{mb: 4, border: '1px solid #ddd', p: 2, borderRadius: 2}}>
                <Grid item xs={6}>
                    <Typography variant="h6"
                                sx={{fontSize: '16px', mb: 1, fontWeight: 'bold', color: '#000'}}>فروشنده:</Typography>
                    <Typography variant="body2"
                                sx={{color: '#000'}}>نام: {agency?.brand_name || "آژانس محتوا"}</Typography>
                    <Typography variant="body2" sx={{color: '#000'}}>شماره
                        تماس: {agency?.phone || "۰۹۱۲..."}</Typography>
                    <Typography variant="body2" sx={{color: '#000'}}>آدرس: {agency?.address || "تهران..."}</Typography>
                </Grid>
                <Grid item xs={6}>
                    <Typography variant="h6"
                                sx={{fontSize: '16px', mb: 1, fontWeight: 'bold', color: '#000'}}>خریدار:</Typography>
                    <Typography variant="body2" sx={{color: '#000'}}>پروژه: {project.project_name}</Typography>
                    <Typography variant="body2"
                                sx={{color: '#000'}}>کارفرما: {project.page_username || '---'}</Typography>
                </Grid>
            </Grid>
            ...
            <TableContainer sx={{mb: 4, border: '1px solid #000', boxShadow: 'none'}}>
                <Table size="small">
                    <TableHead sx={{bgcolor: '#f0f0f0'}}>
                        <TableRow>
                            <TableCell sx={{borderBottom: '1px solid #000', fontWeight: 'bold', color: '#000'}}>شرح
                                خدمات</TableCell>
                            <TableCell align="center"
                                       sx={{borderBottom: '1px solid #000', fontWeight: 'bold', color: '#000'}}>مبلغ
                                واحد (تومان)</TableCell>
                            ...
                            <TableCell align="left"
                                       sx={{borderBottom: '1px solid #000', fontWeight: 'bold', color: '#000'}}>مبلغ کل
                                (تومان)</TableCell>
                        </TableRow>
                    </TableHead>
                    <TableBody>
                        <TableRow>
                            <TableCell sx={{borderBottom: 'none', color: '#000'}}>{payment.description} (بخشی از قرارداد
                                پروژه {project.project_name})</TableCell>
                            <TableCell align="center" sx={{
                                borderBottom: 'none',
                                color: '#000'
                            }}>{formatPrice(payment.amount)}</TableCell>
                ...
                <Box sx={{width: '40%', border: '1px solid #000', p: 2, borderRadius: 1, bgcolor: '#f9f9f9'}}>
                    <Box sx={{display: 'flex', justifyContent: 'space-between', mb: 1}}>
                        ...
                        <Typography fontWeight="bold"
                                    sx={{color: '#000'}}>{formatPrice(payment.amount)} تومان</Typography>
                    </Box>
                    ...
                    <Box sx={{display: 'flex', justifyContent: 'space-between'}}>
                        ...
                        <Typography fontWeight="bold" sx={{
                            color: '#000',
                            fontSize: '1.1rem'
                        }}>{formatPrice(payment.amount)} تومان</Typography>
                    </Box>
                </Box>
            </Box>
