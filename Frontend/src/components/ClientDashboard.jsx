...
const itemVariants = {
    hidden: {y: 20, opacity: 0}, visible: {y: 0, opacity: 1, transition: {type: "spring", stiffness: 50}}
};
...
function ClientDashboard() {
    ...
    const tourSteps = [{
        ...
        target: '#dashboard-stats', content: 'اینجا می‌تونی خلاصه وضعیت مالی و پروژه‌هات رو ببینی.',
    }, {
    ...
    if (loading) return (<Box sx={{p: 3}}>
        <Stack spacing={2}>
            <Skeleton variant="rectangular" height={200} sx={{borderRadius: 4}}/>
            <Grid container spacing={3}>
                <Grid item xs={12} md={4}><Skeleton variant="rectangular" height={150}
                                                    sx={{borderRadius: 4}}/></Grid>
                <Grid item xs={12} md={4}><Skeleton variant="rectangular" height={150}
                                                    sx={{borderRadius: 4}}/></Grid>
                <Grid item xs={12} md={4}><Skeleton variant="rectangular" height={150}
                                                    sx={{borderRadius: 4}}/></Grid>
    ...
    return (<Box sx={{width: '100%', maxWidth: '1600px', mx: 'auto', pb: 5}}>
        ...
        <Joyride
            ...
            styles={{
                options: {
                    ...
                    fontFamily: 'inherit', fontWeight: 'bold', borderRadius: 8
                }, buttonBack: {
                    fontFamily: 'inherit', marginRight: 10 // اصلاح فاصله برای راست‌چین
                }, buttonSkip: {
                    fontFamily: 'inherit', color: theme.palette.error.main
                }
            }}
            // ✅ فارسی سازی دکمه‌ها
            locale={{
                back: 'قبلی', close: 'بستن', last: 'پایان تور', next: 'بعدی', skip: 'دیگر نشان نده' // تغییر متن دکمه اسکیپ
            }}
        />
        ...
        <motion.div variants={containerVariants} initial="hidden" animate="visible">
                    ...
                    <motion.div variants={itemVariants}>
                        <Paper sx={{
                            ...
                            <Stack direction="row" alignItems="center" spacing={2} mb={2}>
                                ...
                                <Typography variant="subtitle1" fontWeight="bold" color="text.secondary">پروژه‌های
                                    فعال</Typography>
                            </Stack>
                    ...
                    <motion.div variants={itemVariants}>
                        <Paper sx={{
                            ...
                            <Stack direction="row" alignItems="center" spacing={2} mb={2}>
                                ...
                                <Typography variant="subtitle1" fontWeight="bold" color="text.secondary">مانده
                                    بدهی</Typography>
                            </Stack>
                    ...
                    <motion.div variants={itemVariants}>
                        <Paper sx={{
                            ...
                            <Stack direction="row" alignItems="center" spacing={2} mb={2}>
                                ...
                                <Typography variant="subtitle1" fontWeight="bold" color="text.secondary">رویداد
                                    بعدی</Typography>
                            </Stack>
                            <Typography variant="h6" fontWeight="bold" color="text.primary">
                                جلسه بررسی سناریو
                            </Typography>
                            <Chip label="فردا ساعت ۱۰:۰۰" size="small" color="info" variant="outlined"
            ...
            <Grid container spacing={3} id="dashboard-projects"> {/* ✅ ID اضافه شد */}
                {projects.length === 0 ? (<Grid item xs={12}>
                    <Paper sx={{
                        p: 5,
                        textAlign: 'center',
                        borderRadius: 4,
                    ...
                    return (<Grid item xs={12} md={6} lg={4} key={project.id}>
                        <motion.div variants={itemVariants}
                            ...
                            >
                                <Box sx={{
                                    ...
                                    width: '100%',
                                    height: 6,
                                    bgcolor: project.is_started ? 'success.main' : 'grey.300'
                                }}/>
                                    ...
                                    <Stack direction="row" spacing={2} alignItems="center">
                                        ...
                                        <Box>
                                            <Typography variant="h6"
                                                        fontWeight="bold">{project.project_name}</Typography>
                                            <Typography variant="caption"
                                                        color="text.secondary">{project.project_type === 'instagram' ? 'مدیریت اینستاگرام' : 'پروژه تکی'}</Typography>
                                        </Box>
                                    </Stack>
                                </Stack>
                                ...
                                <Box mb={3}>
                                    <Stack direction="row" justifyContent="space-between" mb={1}>
                                        <Typography variant="caption" fontWeight="bold"
                                                    color="text.secondary">پیشرفت ماهانه</Typography>
                                        <Typography variant="caption" fontWeight="bold"
