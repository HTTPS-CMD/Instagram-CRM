...
import {alpha, Box, Button, Grid, IconButton, Paper, TextField, Typography, useTheme} from '@mui/material';
import {Add as AddIcon, Close as CloseIcon, PushPin} from '@mui/icons-material';
import {createStickyNote, deleteStickyNote, getStickyNotes} from '../api';
...
const StickyWall = () => {
    ...
    return (
        <Paper sx={{
            ...
            <Typography variant="h6" fontWeight="bold" color="text.primary" mb={2} display="flex" alignItems="center"
                        gap={1}>
            ...
            <Box display="flex" gap={2} mb={3}>
                ...
                />
                <Box display="flex" gap={0.5} alignItems="center" bgcolor={alpha(theme.palette.action.active, 0.05)}
                     p={1} borderRadius={2}>
                    {COLORS.map(c => (
                        <Box
                            key={c}
                ...
                <Button variant="contained" onClick={handleAdd}
                        sx={{borderRadius: 2, minWidth: 50, bgcolor: 'primary.main', color: '#fff'}}>
                    <AddIcon/>
                </Button>
            </Box>
                            ...
                            <motion.div initial={{opacity: 0, scale: 0.8}} animate={{opacity: 1, scale: 1}}
                                ...
                                <Paper sx={{
                                    ...
                                    '&:hover': {
                                        ...
                                        boxShadow: `0 8px 20px ${alpha(note.color, 0.3)}`
                                    }
                                }}>
                                    <IconButton
                                        size="small"
                                    ...
                                    <Typography variant="body1" color="text.primary" sx={{mt: 2, fontWeight: 500}}
