...
class ErrorBoundary extends React.Component {
    ...
    render() {
        if (this.state.hasError) {
            return (<Box
                sx={{
                    display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '100vh', // ✅ استفاده از رنگ پس‌زمینه تم (داینامیک)
                    bgcolor: 'background.default', color: 'text.primary', p: 2, transition: 'background-color 0.3s ease'
                }}
            >
                <Paper
                    elevation={10}
                    sx={{
                        p: 5,
                        borderRadius: 5,
                        textAlign: 'center', // ✅ استایل شیشه‌ای داینامیک با استفاده از تابع theme
                ...
                >
                    ...
                    <Button
                        ...
                        sx={{
                            ...
                            borderRadius: 3, fontWeight: 'bold', px: 4, '&:hover': {bgcolor: 'primary.dark'}
                        }}
                    >
                        تلاش مجدد
                    </Button>
