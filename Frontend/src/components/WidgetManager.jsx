...
import {Close as CloseIcon, Save as SaveIcon, Widgets as WidgetsIcon} from '@mui/icons-material';
    ...
    return (
        <>
            ...
            >
                ...
                <Typography variant="caption" color="text.secondary" mb={3} display="block" fontFamily={"Peyda"}>
                        ...
                        return (
                            ...
                            >
                                <FormControlLabel
                                    ...
                                    label={
                                        <Box ml={1}>
                                            <Typography variant="body2" fontWeight="bold" fontFamily={"Peyda"}
                                                        color="text.primary">{widget.label}</Typography>
                                            <Typography variant="caption"
                                                        color="text.secondary">{widget.desc}</Typography>
                                        </Box>
                                    }
